...
app.post('/destination', function(req, res) {
    ...
    req.body.plans = req.body.plans.split(',').map(function(item) {
        return item.trim();
    });
...
app.delete('/destination/:id', function(req, res) {
    db.Destination.findOneAndRemove({
        _id: req.params.id
    }, function(err, destroy) {
        if (err) {
            return console.log(err)
        };
        res.json(destroy);
...
app.put('/destination/:id', function(req, res) {
    db.Destination.findOne({
        ...
        success.plans = req.body.updatePlans.split(',').map(function(item) {
            return item.trim();
        });
